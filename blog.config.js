const BLOG = {
  ...
  description: 'Notionic, A static blog build on top of Notion and Next.js',
  ...
  telegramChannelUrl: 'https://xxx/', // The link of your Telegram channel
  telegramChannelName: 'MuXin', // The name of your Telegram channel
